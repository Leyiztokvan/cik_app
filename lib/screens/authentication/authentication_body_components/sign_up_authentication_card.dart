...
class XSignUpAuthenticationCard extends StatefulWidget {
  const XSignUpAuthenticationCard({Key? key}) : super(key: key);

  @override
  State<XSignUpAuthenticationCard> createState() =>
      _XSignUpAuthenticationCardState();
}

class _XSignUpAuthenticationCardState extends State<XSignUpAuthenticationCard> {
  ...
  Widget build(BuildContext context) {
    return Container(
        height: 305,
        // height: (MediaQuery.of(context).size.height - _appBarHeight) * 0.49,
