...
class XCardPopularDetailsScreen extends StatelessWidget {
  const XCardPopularDetailsScreen({
    Key? key,
                      ...
                      child: Center(
                        child: Container(
                          ...
                          child: Center(
                            ...
                            child: Container(
                              // // /The the Container resize it self when in landscape mode
                              height: MediaQuery.of(context).size.height * 0.3,
...
//         margin: EdgeInsets.only(left: 0, right: bPrimaryScreenBorderLR + mSecondaryMarginLR),
//         height: 30,
//         width: double.infinity,
//         child: Row(
//           mainAxisSize: MainAxisSize.min,
...
//                                               children: [
//                                                 Container(
//                                                     child: cComponents.icon3),
//                                                 SizedBox(
//                                                   height: 10,
//                                                 ),
//                                                 Container(
//                                                     child: cComponents.icon4),
//                                               ],
//                                             ),
//                                           ),
//                                         ]),
