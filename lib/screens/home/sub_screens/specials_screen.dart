...
class XSpecialsScreen extends StatefulWidget {
  const XSpecialsScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<XSpecialsScreen> createState() => _XSpecialsScreenState();
}

class _XSpecialsScreenState extends State<XSpecialsScreen> {
