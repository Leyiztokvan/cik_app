...
class XShoppingBagButton extends StatefulWidget {
  ...
  final Color iconColor = cDarkGrey;
  ...
  @override
  _XShoppingBagButtonState createState() => _XShoppingBagButtonState();
}

class _XShoppingBagButtonState extends State<XShoppingBagButton>
